...
public class ModifyingWordrpess3 {
...
static Properties prp;
   ...
   //Cannot inject @Test annotated Method [loginWordpress] with [class java.lang.String, class java.lang.String, class java.lang.String].
	@Test
	public static void loginWordpress(String url, String email, String password) throws Exception{
	   ...
	   // driver.get("https://wordpress.com/?apppromo");
		...
		home.Email().sendKeys(prp.getProperty(email));
         home.getPassword().sendKeys(prp.getProperty(password));
         home.LogIn().click();
      String title=   driver.getTitle();
         ...
         Thread.sleep(4000L);
         post.hitTitle().sendKeys(prp.getProperty("ptitle"));
         
         
          post.writeText().sendKeys(prp.getProperty("message"));
